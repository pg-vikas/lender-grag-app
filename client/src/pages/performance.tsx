...
export default function PerformancePage() {
  ...
  const performanceMetrics = [
    { title: "Total Actions", value: "263", color: "text-indigo-400" },
    { title: "Active Minutes", value: "5 hrs 26 mins", color: "text-emerald-400" },
    { title: "Idle Minutes", value: "80 hrs 15 mins", color: "text-slate-400" },
    { title: "Leads Contacted", value: "4", color: "text-purple-400" },
    { title: "Follow-ups Completed", value: "14", color: "text-orange-400" },
    { title: "Response Rate", value: "0.0%", color: "text-rose-400" },
    { title: "Projects", value: "28", color: "text-teal-400" },
    { title: "Conversions", value: "8", color: "text-indigo-400" }
  ];
  ...
  const leaderboardData = [
    { rank: "#1", name: "PR Admin", actions: 173, active: "3 hrs 49 mins", idle: "75 hrs 45 mins", sessions: "1 hr 25 mins", color: "bg-orange-500" },
    { rank: "#2", name: "Sale Admin", actions: 32, active: "21 minutes", idle: "25 minutes", sessions: "22 minutes", color: "bg-slate-400" },
    { rank: "#3", name: "Vikas Dev", actions: 21, active: "1 hr 16 mins", idle: "2 hrs 12 mins", sessions: "0 second", color: "bg-cyan-500" },
    { rank: "#4", name: "Chayan", actions: 15, active: "0 second", idle: "0 second", sessions: "0 second", color: "" },
    { rank: "#5", name: "Neeraj", actions: 5, active: "0 second", idle: "1 hr 53 mins", sessions: "0 second", color: "" },
    { rank: "#6", name: "Jordan", actions: 2, active: "0 second", idle: "0 second", sessions: "0 second", color: "" }
  ];

  const lowActivityData = [
    { name: "Neeraj", actions: 5, threshold: 10, status: "Below Threshold" },
    { name: "Jordan", actions: 2, threshold: 10, status: "Below Threshold" }
  ];

  const barChartData = [
    { name: 'PR Admin', actions: 173 },
    { name: 'Sale Admin', actions: 32 },
    { name: 'Vikas Dev', actions: 21 },
    { name: 'Chayan', actions: 15 },
    { name: 'Neeraj', actions: 5 },
    { name: 'Jordan', actions: 2 },
  ];
                  ...
                  <tbody className="divide-y divide-slate-800/50">
                    {leaderboardData.map((row, i) => (
                      <tr key={i} className="hover:bg-slate-800/30 transition-colors">
                        ...
                        <td className="py-4 px-4">
                          <button className="bg-indigo-600 hover:bg-indigo-500 text-white text-xs font-medium px-4 py-1.5 rounded transition-colors shadow-[0_0_10px_rgba(79,70,229,0.3)]">
                            View Details
                          </button>
                        </td>
                      </tr>
