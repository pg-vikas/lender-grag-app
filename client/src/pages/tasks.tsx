      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <main className="flex-1 overflow-y-auto p-6 lg:p-8">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="bg-white p-6 mb-6 rounded-lg shadow-[0_2px_10px_rgba(0,0,0,0.02)] border border-[#f1f5f9]">
              <div className="flex flex-col md:flex-row gap-6 items-end">
                <div className="flex-1 w-full max-w-[320px]">
                  ...
                  <input 
                    type="text" 
                    className="w-full h-[40px] px-3 border border-[#e2e8f0] rounded-md focus:outline-none focus:border-primary/30 text-sm" 
                  />
                </div>
                <div className="flex-1 w-full max-w-[320px]">
            ...
            <div className="bg-white min-h-[400px] rounded-lg shadow-[0_2px_10px_rgba(0,0,0,0.02)] border border-[#f1f5f9]">
              <div className="p-6 overflow-x-auto border-b border-[#f1f5f9]">
                <div className="flex gap-3 min-w-max">
                  <button className="px-4 py-2 bg-[#8b5cf6] text-white rounded-md text-[13px] font-medium transition-colors">
                    Today's Tasks (0)
                  </button>
                  <button className="px-4 py-2 bg-[#f8fafc] text-[#475569] hover:bg-[#f1f5f9] rounded-md text-[13px] font-medium transition-colors">
                    Overdue Tasks (0)
                  </button>
                  <button className="px-4 py-2 bg-[#f8fafc] text-[#475569] hover:bg-[#f1f5f9] rounded-md text-[13px] font-medium transition-colors">
                    Future Tasks (0)
