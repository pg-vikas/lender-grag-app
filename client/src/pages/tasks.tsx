            ...
            <div className="glass-panel rounded-2xl border-t border-indigo-500/20 p-6 mb-6  border border-white/10">
              <div className="flex flex-col md:flex-row gap-6 items-end">
                <div className="flex-1 w-full max-w-[320px]">
                  ...
                  <input 
                    type="text" 
                    className="w-full h-[40px] px-3 border border-white/10 rounded-md focus:outline-none focus:border-indigo-500/50 focus:ring-1 focus:ring-indigo-500/50 text-sm" 
                  />
                </div>
                <div className="flex-1 w-full max-w-[320px]">
