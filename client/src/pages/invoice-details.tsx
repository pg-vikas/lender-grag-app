        ...
        <main className="flex-1 overflow-y-auto p-6 lg:p-8">
          <div className="max-w-5xl mx-auto">
            <div className="flex justify-between items-center mb-8">
              ...
              <button className="w-10 h-10 flex items-center justify-center bg-white border border-[#e2e8f0] rounded-lg text-[#475569] shadow-sm hover:bg-[#f8fafc] transition-colors">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-[#e2e8f0] p-8 md:p-12 mb-6">
               ...
               <div className="flex flex-col md:flex-row justify-between gap-8 border-b border-[#f1f5f9] pb-8 mb-8">
