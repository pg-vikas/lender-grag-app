        ...
        <main className="flex-1 overflow-y-auto p-6 lg:p-8 relative">
          <div className="max-w-[1400px] mx-auto">
            <div className="flex justify-between items-center mb-6">
              ...
              <button className="flex items-center gap-2 px-4 py-2 bg-white border border-[#e2e8f0]/80 rounded-xl shadow-sm text-sm font-medium text-[#475569] shadow-sm hover:bg-[#f8fafc] transition-colors">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <div className="space-y-6">
                  ...
                  <div className="space-y-5">
                    ...
                    <div>
                      ...
                      <div className="pl-6 mt-1">
                        <span className="inline-flex items-center justify-center px-4 py-1 rounded-full text-xs font-medium text-gray-500 border border-gray-200 bg-white">
                          Low
                        </span>
                      </div>
                    </div>
                ...
                {/* Attachments */}
                <div className="bg-white rounded-xl p-6 shadow-sm border border-[#e2e8f0] flex justify-between items-center">
              ...
              <div className="lg:col-span-2 space-y-6">
                ...
                {/* Tasks */}
                <div className="bg-white rounded-xl p-6 shadow-sm border border-[#e2e8f0] min-h-[300px] flex flex-col">
                   <div className="flex justify-between items-center mb-6">
                     <h2 className="text-[16px] font-bold text-[#0f172a]">Tasks</h2>
                     <div className="flex items-center gap-2">
                        <button className="w-8 h-8 flex items-center justify-center rounded border border-[#e2e8f0] text-[#94a3b8] bg-[#f8fafc] hover:bg-[#f1f5f9] transition-colors">
                        ...
                        <button className="flex items-center gap-1.5 px-3 py-1.5 bg-white border border-[#e2e8f0]/80 rounded-xl shadow-sm text-sm font-medium text-[#475569] shadow-sm hover:bg-[#f8fafc] transition-colors ml-1">
                   ...
                   <div className="flex-1 flex flex-col items-center justify-center text-white drop-shadow-[0_0_8px_rgba(255,255,255,0.5)]enter py-12">
                      <div className="relative mb-6">
                         ...
                         <div className="w-20 h-20 rounded-full border border-[#e2e8f0] flex items-center justify-center bg-white shadow-sm relative z-10">
                ...
                <div className="bg-white rounded-xl p-6 shadow-sm border border-[#e2e8f0]">
                   <div className="flex justify-between items-center mb-6">
                     ...
                     <button className="flex items-center gap-1.5 px-3 py-1.5 bg-[#f8fafc] border border-[#e2e8f0] rounded-lg text-sm font-medium text-[#475569] shadow-sm hover:bg-[#f1f5f9] transition-colors">
