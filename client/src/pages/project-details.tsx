        ...
        <main className="flex-1 overflow-y-auto p-6 lg:p-8">
          <div className="max-w-[1400px] mx-auto">
            <div className="flex justify-between items-center mb-6">
              ...
              <button className="flex items-center gap-2 px-4 py-2 bg-white border border-[#e2e8f0] rounded-lg text-sm font-medium text-[#475569] shadow-sm hover:bg-[#f8fafc] transition-colors">
                ...
                <div className="bg-white rounded-xl p-6 shadow-sm border border-[#e2e8f0] min-h-[300px] flex flex-col">
                   <div className="flex justify-between items-center mb-6">
                     ...
                     <div className="flex items-center gap-2">
                        ...
                        <button className="flex items-center gap-1.5 px-3 py-1.5 bg-white border border-[#e2e8f0] rounded-lg text-sm font-medium text-[#475569] shadow-sm hover:bg-[#f8fafc] transition-colors ml-1">
