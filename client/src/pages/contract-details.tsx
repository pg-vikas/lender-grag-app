      ...
      <div className="flex-1 flex flex-col min-w-0 bg-white ">
        ...
        <main className="flex-1 overflow-y-auto p-6 lg:p-8 relative">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-white shadow-[0_2px_10px_rgba(0,0,0,0.08)] overflow-hidden border border-[#e2e8f0]">
              ...
              <div className="relative h-48 bg-gradient-to-r from-purple-800 to-indigo-900 flex flex-col items-center justify-center text-white overflow-hidden">
                ...
                <div className="absolute top-6 left-0">
                  <span className="bg-white  px-4 py-1.5 rounded-r-md text-sm font-medium">Draft</span>
                </div>
              ...
              <div className="p-10 md:p-14">
                ...
                <div className="flex flex-col md:flex-row justify-between mb-16 gap-10">
                  <div className="flex-1">
                    <h2 className="text-[16px] font-semibold text-[#0f172a] mb-4">Service Provider / Company</h2>
                    <h3 className="text-[15px] font-bold text-[#0f172a] mb-2">Pink Gorilla</h3>
                  ...
                  <div className="flex-1 md:text-right">
                    <h2 className="text-[16px] font-semibold text-[#0f172a] mb-4">Client</h2>
                    <h3 className="text-[15px] font-bold text-[#0f172a] mb-2">Pink Gorilla Agency</h3>
                    <div className="text-[13px] text-[#475569] leading-relaxed">
                      <p>+1 555 123 4567</p>
                ...
                <div className="flex flex-col md:flex-row justify-between gap-10">
                  <div className="flex-1">
                    <h3 className="text-[14px] font-semibold text-[#0f172a] mb-6">Service Provider</h3>
                    <p className="text-[13px] text-[#475569] mb-4">Chayan Alavi</p>
                    ...
                    <p className="text-[12px] text-[#64748b]">Date : 05-01-2026</p>
                  </div>
                  
                  <div className="flex-1 md:text-right">
                    <h3 className="text-[14px] font-semibold text-[#0f172a] mb-6">Client</h3>
                    <p className="text-[14px] text-[#94a3b8]">Unsigned</p>
                  </div>
                </div>
              </div>
