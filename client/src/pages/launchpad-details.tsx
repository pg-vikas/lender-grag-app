              ...
              <div className="lg:col-span-2">
                <div className="glass-panel rounded-2xl border border-white/10 h-full flex flex-col min-h-[600px] overflow-hidden">
                  ...
                  <div className="flex border-b border-slate-800 overflow-x-auto scrollbar-hide">
                    <button className="px-4 py-3 text-sm font-medium text-purple-400 border-b-2 border-purple-500 whitespace-nowrap">Chat</button>
                    <button className="px-4 py-3 text-sm font-medium text-slate-400 hover:text-slate-200 transition-colors whitespace-nowrap">Public Notes</button>
                    <button className="px-4 py-3 text-sm font-medium text-slate-400 hover:text-slate-200 transition-colors whitespace-nowrap">Private Notes</button>
                    <button className="px-4 py-3 text-sm font-medium text-slate-400 hover:text-slate-200 transition-colors whitespace-nowrap">Uploads</button>
                    <button className="px-4 py-3 text-sm font-medium text-slate-400 hover:text-slate-200 transition-colors whitespace-nowrap">Activities</button>
                  </div>
